			...
			case '2':{
				...
				if(index!=-1) {
					...
					do {
						...
						System.out.println("Press 8 to Save the Account Info in Database|");
						System.out.println("Press 9 to  logout  from      this  Account |");
						System.out.println("#############################################");
						...
						case '8':{
							...
							char check1; 
							System.out.println("########################################################");
							System.out.println("Press 1 to save Account Information to file   Database |");
							System.out.println("Press 2 to save Account Information to Oracle Database |");
							System.out.println("Press 3 to save Account Information to MySql  Database |");
							System.out.println("########################################################");
							check1= sc.next().charAt(0);
							System.out.println("--------------------------------------------------------");
							
							switch (check1) {
								case '1':
								{
									p= new fileSystemHandler();
									p.saveAccount(bank.getuserAccounts(AccId, index));
									break;
								}
								case '2':
								{
									p= new oracleDbHandler();
									p.saveAccount(bank.getuserAccounts(AccId, index));
									break;
								}
								case '3':
								...
								default:
								{
									System.out.println("Select the appropriate option from the Menu");
									break;
								}
							}
